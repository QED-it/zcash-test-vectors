// From https://github.com/zcash-hackworks/zcash-test-vectors/ (unified_address)
...
pub(crate) struct TestVector {
    ...
    pub(crate) unknown_typecode: u32,
    pub(crate) unknown_bytes: Option<Vec<u8>>,
    pub(crate) unified_addr: Vec<u8>,
