...
from .asset_id import derive_asset_base, asset_digest, encode_asset_id, native_asset
...
def test_value_commit():
    ...
    asset_base = derive_asset_base(asset_digest(encode_asset_id(randbytes(32), randbytes(512))))
    assert value_commit(rcv, v, asset_base) == VALUE_COMMITMENT_RANDOMNESS_BASE * rcv + asset_base * v
